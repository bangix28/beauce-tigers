      ...
      <div v-else>
        ...
        >
          <div
            ...
            :key="idx"
            class="flex flex-col items-center justify-between p-4 bg-gray-800 rounded-lg shadow-xl transition transform hover:scale-105 duration-300 flex-shrink-0 lg:flex-shrink-1 basis-[35vw] sm:basis-[15rem] md:basis-[13rem] lg:basis-100"
            :class="[
